...
/**
 * Bright signal packets travelling along synapse edges. They read as the
 * network "thinking": gold sparks that the bloom pass turns into light.
 */
export default function Pulses({ data, count }: { data: NetworkData; count: number }) {
  ...
  useFrame((_, delta) => {
    ...
    for (let i = 0; i < pulses.length; i++) {
      ...
      // Sparks flare mid-flight and shrink at the endpoints.
