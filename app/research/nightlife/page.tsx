          ...
          <div className="rp-faq-list">
            {[
              ...
              },
              {
                ...
                a: "No personally identifying information is required to participate. Responses are intended to be analysed in aggregate as a voluntary Hospitality-domain research input under the study's stated terms; any broader HBIF use remains subject to the applicable research and privacy boundaries.",
              },
              {
                q: "Why does Polynovea run this study?",
                a: "The study captures self-reported decision context around nightlife and venue choices - what triggers a night out, what keeps someone at a venue, and what makes them leave - as one evidence source within Polynovea's Hospitality research lineage.",
              },
              {
